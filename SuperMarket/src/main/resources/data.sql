...
INSERT IGNORE INTO products(name, barcode, price, stock, active, category_id)
VALUES
...
INSERT IGNORE INTO suppliers(name, nit, phone, email)
VALUES
...
INSERT IGNORE INTO product_supplier(product_id, supplier_id)
VALUES
(1, 1),
(2, 2),
(3, 3),
...
INSERT IGNORE INTO employees(id_number, name, position, hire_date, salary)
VALUES
...
INSERT IGNORE INTO sales(sale_date, subtotal, tax, total, employee_id)
VALUES
('2026-05-20', 10000, 1900, 11900, 2);

INSERT IGNORE INTO sale_details(quantity, unit_price, subtotal, sale_id, product_id)
VALUES
(2, 5000, 10000, 1, 3);